...
if (data_is_available){
  ...
  #####
  # Get and fix coordinates and sizes of vertices for visualization purposes
  #####
  ...
  set.seed(3)
  am.coord <- igraph::layout.fruchterman.reingold(union)
  vsize <- rowMeans(clr(data_sex_male_OTU_table, 1)) + 6
...
#####
# Perform symmetric difference analysis on male and female data. 
# We used the SpiecEasi mb inferred network, but one can use any other tool
#####
