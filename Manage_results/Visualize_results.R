...
load(paste("../Results/SE_gl/results_SE_gl_e-d_reps_100_zinegbin_samples_",no_samples,"_p_127_cn_100_",graph_type,".RData", sep=''), verbose=TRUE)
temp1 <- temp
load(paste("../Results/SE_mb/results_SE_mb_e-d_reps_100_zinegbin_samples_",no_samples,"_p_127_cn_100_",graph_type,".RData", sep=''), verbose=TRUE)
temp2 <- temp
load(paste("../Results/SPRING/results_SPRING_e-d_reps_100_zinegbin_samples_",no_samples,"_p_127_cn_100_",graph_type,".RData", sep=''), verbose=TRUE)
temp3 <- temp
load(paste("../Results/HARMONIES/results_HARMONIES_e-d_reps_100_zinegbin_samples_",no_samples,"_p_127_cn_100_",graph_type,".RData", sep=''), verbose=TRUE)
temp4 <- temp
load(paste("../Results/gCoda/results_gCoda_e-d_reps_100_zinegbin_samples_",no_samples,"_p_127_cn_100_",graph_type,".RData", sep=''), verbose=TRUE)
temp <- res_gcoda
temp5 <- temp
load(paste("../Results/COZINE/results_COZINE_e-d_reps_100_zinegbin_samples_",no_samples,"_p_127_cn_100_",graph_type,".RData", sep=''), verbose=TRUE)
temp6 <- temp
